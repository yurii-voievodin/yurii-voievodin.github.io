...
export default function WidePhotoCarousel({ images, className = '' }: WidePhotoCarouselProps) {
  ...
  const { selectedImage, openLightbox, closeLightbox, nextImage, prevImage } = useLightbox(images.length);
  ...
  return (
    <>
      <div className={`relative w-full ${className}`}>
        <div
          className="relative w-full aspect-[16/10] overflow-hidden rounded-2xl shadow-lg bg-zinc-900 cursor-pointer"
