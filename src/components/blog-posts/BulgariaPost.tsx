...
import { bulgariaPhotos } from '@/lib/bulgaria-2025-2026-data';
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Hero Section */}
        <div className="relative rounded-3xl shadow-2xl overflow-hidden mb-12 border border-red-500/20">
          {/* Background Image */}
