...
import { firstAndSecondCarPhotos } from '@/lib/first-and-second-car-data';

interface FirstAndSecondCarPostProps {
  post: Post;
}

export default function FirstAndSecondCarPost({ post }: FirstAndSecondCarPostProps) {
  const [selectedImage, setSelectedImage] = useState<number | null>(null);
  const [imageLoading, setImageLoading] = useState<{ [key: number]: boolean }>({});

  const images = firstAndSecondCarPhotos;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative rounded-3xl shadow-2xl overflow-hidden mb-12 border border-orange-500/20">
          ...
          <div className="absolute inset-0">
            <Image
              src={post.featuredImage || "/first-and-second-car/IMG_1298.jpeg"}
              alt="Car collection memories"
              fill
          ...
          <div className="relative p-8 md:p-12 text-center text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight drop-shadow-lg">
              Car Collection Memories
            </h1>
            <p className="text-xl md:text-2xl opacity-90 max-w-4xl mx-auto leading-relaxed drop-shadow-md">
              A collection of photos documenting my first and second car adventures from 2018 to 2024
            </p>
        ...
        <div className="bg-zinc-800/50 rounded-2xl p-8 shadow-lg border border-zinc-700/50 mb-12">
          ...
          <p className="text-lg text-zinc-300 leading-relaxed">
            This collection spans from 2018 to 2024, capturing memories with my first and second cars.
            Each photograph represents a moment in time, a journey, or an experience that made these vehicles
            more than just transportation. From everyday moments to special occasions, these images tell the
            story of reliability, adventure, and the roads traveled.
          </p>
        </div>
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-zinc-100 mb-8 flex items-center">
            <Camera className="mr-3 text-orange-400" size={32} />
            Photo Gallery
          </h2>
        ...
        {/* Additional Info */}
        <div className="bg-gradient-to-r from-orange-600/10 to-amber-600/10 rounded-2xl p-8 border border-orange-500/20">
          <h3 className="text-2xl font-bold text-zinc-100 mb-4">
            The Journey Through Time
          </h3>
          <p className="text-zinc-300 leading-relaxed mb-6">
            From 2018 to 2024, these vehicles have been part of countless memories and experiences.
            Whether navigating city streets, embarking on road trips, or simply being there for daily life,
            they represent more than mechanics and metal. These photos capture the essence of companionship
            between driver and machine, the places visited, and the moments shared along the way.
          </p>
          <p className="text-zinc-400 text-sm">
            The photos were taken between 2018 and 2024, capturing various moments and locations.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-violet-100 mb-6">
            Interested in more adventures and insights? Check out my other blog posts!
          </p>
          <Link
            href="/blog"
