...
import { Calendar, Clock, ArrowLeft, MapPin, Camera, Image as ImageIcon, Maximize2, X, CarFront } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Hero Section */}
        <div className="relative rounded-3xl shadow-2xl overflow-hidden mb-12 border border-green-500/20">
          {/* Background Image */}
          <div className="absolute inset-0">
            <Image
              src="/land_rover/mountain.jpg"
