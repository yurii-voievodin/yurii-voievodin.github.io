    ...
    <div className="space-y-12">
      ...
      <section className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-zinc-800/50 p-6 rounded-lg shadow-lg border border-zinc-700/50">
          ...
          <p className="text-zinc-300 mb-4">Explore my photography, favorite movies & series, and games that I enjoy.</p>
          <Link href="/personal" className="inline-flex items-center bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent hover:from-violet-300 hover:to-purple-300 font-medium transition-all">Explore personal page<ArrowRight className="ml-1 text-violet-400 hover:text-violet-300 transition-colors" size={16} /></Link>
        </div>
      </section>
    </div>
  );
