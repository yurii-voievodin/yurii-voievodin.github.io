    ...
    <div className="max-w-4xl mx-auto">
      ...
      <header className="bg-zinc-800/50 rounded-lg shadow-lg border border-zinc-700/50 p-8 mb-8">
        <div className="flex justify-between items-start">
          ...
          <button className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-colors shadow-lg hover:shadow-blue-500/20">
            <Download size={16} />
