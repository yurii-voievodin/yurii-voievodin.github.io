...
export default function CVPage() {
  return (
    ...
    <a href="tel:+48575399261" className="flex items-center space-x-2 hover:text-blue-400 transition-colors">
    <Phone size={16} />
    <span className="text-sm sm:text-base">+48 575 399 261</span>
    </a>
    </div>
    </div>
